# copied from src/main_challenge_manipulation_phase2.py
...
parser.add_argument("--env_name",type=str,default="Bimanual", help="Name of the environment",)
...
parser.add_argument("--pos_th", type=float, default=.1)
parser.add_argument("--rot_th", type=float, default=np.inf)
