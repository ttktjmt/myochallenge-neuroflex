...
envs_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "envs")
...
# import envs # for using CustomBimanualEnv-v0
...
class evaluator_environment:
    def __init__(self, environment="CustomBimanualEnv-v0"):
        self.score = 0
        self.feedback = None
